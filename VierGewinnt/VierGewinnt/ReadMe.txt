========================================================================
    KONSOLENANWENDUNG: VierGewinnt-Projektübersicht
========================================================================

Diese VierGewinnt-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre VierGewinnt-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "VierGewinnt.pch und eine 
